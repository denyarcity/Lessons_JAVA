...
public class Laptop {
    ...
    public String searchModels() {
        System.out.println("---> УКАЖИТЕ МИНИМАЛЬНЫЕ ХАРАКТЕРИСИКИ НОУТБУКА:");
        ...
        if (resultList.size() > 0)
            ...
            return "По вашему запросу ничего не найдено. Попробуйте задать иные параметры";
    }
